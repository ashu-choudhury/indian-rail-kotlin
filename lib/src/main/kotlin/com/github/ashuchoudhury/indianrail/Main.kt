...
fun main() = runBlocking {
    ...
    if (trains.success && trains.data != null) {
        ...
        println("Failed to fetch trains. Error: ${trains.error}")
    }

    println("\nFetching route for 12301 (Rajdhani Express)...")
    val route = client.getTrainRoute("12301")
    if (route.success && route.data != null) {
        ...
        println("Failed to fetch route. Error: ${route.error}")
    }
